...
-   Edit menu for any date with real-time preview
-   Reusable flavor library across all menus
...
-   Perfect for prototype/interview demo
-   Zero configuration
-   File-based (portable)
-   Supports transactions

### Why Separate Flavor Definitions?

-   Avoids data duplication
-   Makes flavor management centralized
-   Historical menus stay intact when flavors change
-   Supports future features (flavor analytics, trends)

### Why Full Menu Replacement?

-   Simpler reasoning about state
-   Idempotent (safe to retry)
-   Easier to test and debug
-   Matches user mental model ("here's today's menu")

### Performance Optimizations

-   `useMemo` for menu comparison (prevents unnecessary re-renders)
-   Transaction-wrapped database updates
-   Indexed foreign keys
-   Single API call for all flavors (with JOIN for statistics)
...
-   [ ] User authentication
-   [ ] Multi-store support
-   [ ] Flavor creation/editing UI
-   [ ] Analytics dashboard (trending flavors)
-   [ ] Automated menu suggestions based on history
...
Built in ~3-4 hours focusing on:
...
This is a technical prototype for interview purposes.
